...
public class AssignmentNo3 {
        static int[][] studentGrade(String [] name){
            Scanner sc =new Scanner(System.in);
            System.out.print("Please input number of student again: ");
            int student = sc.nextInt();
            System.out.print("Input number of week (1-7): ");
            int week = sc.nextInt();
            int grade[] []= new int[student][week];
            for (int i = 0; i < name.length; i++){
                System.out.print("Input the name of the student " + (i+1) + ": ");
                name [i] = sc.next();
            }
            System.out.println();
            System.out.println("===========================");
        ...
        static void displayAllGrades(int[][] grade, String [] name){
            System.out.println("===========================");
        ...
        static void highestGrade(int [][] grade){
            System.out.println("================================================================");
            int a = 0;
            int maxNum = 0;
            for (int i=0; i<grade[1].length;i++){   
        ...
        static void highestGradeforEachWeek(int [][] grade, String[] name){
            System.out.println("===============================");
        ...
        public static void main(String[] args) {
            ...
            int [][] grade = studentGrade(name);
            displayAllGrades(grade, name);;
            highestGrade(grade);
            highestGradeforEachWeek(grade, name);
        }
}
